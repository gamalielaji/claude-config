...
description: "Owns code architecture, coding standards, code review, and work assignment. Use for API design, refactoring strategy, or code structure decisions."
